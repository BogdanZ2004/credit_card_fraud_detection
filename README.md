...
| Random Forest (150) | 0.9016 | 0.7746 | 0.8333 | 0.9723 | 0.8153 |
| XGBoost | 0.7671 | 0.7887 | 0.7778 | 0.9594 | 0.8109 |
| Baseline (nasumičan) | 0.0000 | 0.0000 | — | — | 0.0008 |

**Izbor modela (na validaciji): RandomForest_100** (AUPRC 0.8560). Tri ansambla su praktično izjednačena — na test skupu RF-150 (0.8153) i RF-100 (0.8143) su gotovo identični, XGBoost tik iza (0.8109). Svi modeli su **drastično bolji od baseline-a** (0.0008), što dokazuje da uče prave obrasce.
...
| Stablo odlučivanja | `max_depth=10, min_samples_leaf=8, criterion=entropy` | 0.5865 |
| Random Forest (100) | `max_features=log2, max_depth=None` | 0.8426 |
| Random Forest (150) | `max_features=log2, max_depth=None` | 0.8430 |
| XGBoost | `learning_rate=0.3, max_depth=7, subsample=0.8, colsample_bytree=1.0` | 0.8355 |
